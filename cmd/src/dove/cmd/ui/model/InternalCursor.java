...
public class InternalCursor
     ...
     */
    public InternalCursor(int screenWidth, int screenHeight) {
    ...
    public void commandLineChanged(CommandLineEvent e) {
         ...
         */
        if (e.getSourceType() == CommandLineEvent.SOURCE_TYPE.BUFFER_TYPE && e.getModifier() == InternalCharBuffer.BUFFER_CLIPPED) {
            InternalCharBuffer srcBuffer = ((InternalCharBuffer) e.getSource());
